...
function FeaturedBusinesses() {
  ...
  return (
    <div className="w-[1320px] h-[370px] m-auto p-5 gap-20">
      <Slider {...settings}>
        {featured.map((feature, index) => (
          <div className="p-10 drop-shadow-md hover:drop-shadow-2xl rounded-3xl border-md shadow-lg px-2 w-[420px] h-[370px] mr-[27px] flex-wrap space-x-4">
            <Image
      ...
      {/* <div className="w-[420px] h-[370px] drop-shadow-md rounded-3xl hover:drop-shadow-2xl ransition ease-in-out delay-150 bg-white hover:-translate-y-2 hover:bg-white duration-300">
        <Image src={construction} alt="feature" width={420} height={250}/>
        <h2 className="text-xl">Browns H20 proofing systems</h2>
      </div> */}
    </div>
  );
